...
*Note: See the corresponding [cookbook about git](/cookbook/git.html). This page has lecture notes.*
...
X/Windows, assuming you have installed Git.
    ...
    mkdir demo1                           # create a new directory
    cd demo1                              # go into that directory
